class IterableObject {
  static create = obj => new IterableObject(obj)
  constructor(obj) {
    this.obj = obj
  }
  ...
  reduce = (fn, initial) =>
    IterableObject.create(this.iterate().reduce((result, entry, i) => fn(result, entry, i, this.obj), initial))
  map = fn =>
...
export default obj => IterableObject.create(obj)
